...
export default {
  dashboard: {
    title: 'Crea tu App',
    description: 'Crea tu app sobre Convex SaaS, explora la documentación y comienza tu viaje.',
    bodyTitle: 'Comenzar',
    bodyDescription: 'Explora el panel de control y comienza con tu primera app.',
  ...
  settings: {
    ...
    avatar: {
      ...
      uploadHint: 'Haz clic en el avatar para subir uno personalizado desde tus archivos.',

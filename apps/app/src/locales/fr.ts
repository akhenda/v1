export default {
  dashboard: {
    ...
    bodyTitle: 'Commencez',
    bodyDescription: 'Explorez le tableau de bord et commencez avec votre première application.',
  ...
  settings: {
    ...
    avatar: {
      ...
      uploadHint: "Cliquez sur l'avatar pour en télécharger un personnalisé depuis vos fichiers.",

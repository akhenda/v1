          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                <Text style={[styles.textXS, styles.monospace]}>nx lint ryde</Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>
                  nx run-many -p ryde -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>nx show project ryde</Text>
              </View>
              <View style={styles.listItem}>
                <Svg width={24} height={24} stroke="#000000" fill="none" viewBox="0 0 24 24">
                  <Path
...
const styles = StyleSheet.create({
  ...
  monospace: { color: '#ffffff', fontFamily: 'Courier New', marginVertical: 4 },
  comment: { color: '#cccccc' },
  marginBottomSm: { marginBottom: 6 },
  ...
  textLg: { fontSize: 24 },
  textXL: { fontSize: 48 },
  textContainer: { marginVertical: 12 },
  ...
  hero: { borderRadius: 12, backgroundColor: '#143055', padding: 36, marginBottom: 24 },
  heroTitle: { flex: 1, flexDirection: 'row' },
  heroTitleText: { color: '#ffffff', marginLeft: 12 },
  heroText: { color: '#ffffff', marginVertical: 12 },
  ...
  connectToCloudButtonText: { color: '#ffffff' },
  whatsNextButton: {
